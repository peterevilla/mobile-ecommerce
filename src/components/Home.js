  ...
  return (
    <div className="lg:p-16">
      <div className="flex flex-col">
        <div className="h-auto  bg-purple-200 rounded p-16 flex flex-col lg:flex-row justify-around">
          <div className="flex flex-col">
            <p className="text-4xl">Korg MS-20</p>
            <p className="my-3">From $400</p>
            <Link to="/synth">
              <div className=" h-10 py-1 border-black border hover:bg-black hover:text-white my-3">
        ...
        <div className="flex flex-col lg:flex-row mt-8 justify-between ">
          <div className="h-xl lg:w-1/2 rounded  bg-gray-200  p-8 hover:bg-gray-300 flex flex-col justify-center">
        ...
        <div className="h-xl lg:w-64 rounded  bg-gray-200  p-8 hover:bg-gray-300 flex flex-col justify-center">
            <img
              className=""
              src="https://www.bettermusic.com.au/media/catalog/product/cache/1/image/1224x/9df78eab33525d08d6e5fb8d27136e95/2/5/2507210502_gtr_frt_001_rr.png"
              alt="guitar"
